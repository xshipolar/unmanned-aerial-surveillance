...
static void mavlink_test_vision_target_position_estimate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vision_target_position_estimate_t packet_in = {
	...
	mavlink_vision_target_position_estimate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_position_estimate_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vision_target_position_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_position_estimate_pack(system_id, component_id, &msg , packet1.t_usec , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.frame );
	mavlink_msg_vision_target_position_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_position_estimate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.t_usec , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.frame );
	mavlink_msg_vision_target_position_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vision_target_position_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_position_estimate_send(MAVLINK_COMM_1 , packet1.t_usec , packet1.x , packet1.y , packet1.z , packet1.roll , packet1.pitch , packet1.yaw , packet1.frame );
	mavlink_msg_vision_target_position_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vision_target_velocity_estimate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vision_target_velocity_estimate_t packet_in = {
		93372036854775807ULL,
	73.0,
	101.0,
	129.0,
	...
	mavlink_vision_target_velocity_estimate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.t_usec = packet_in.t_usec;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_velocity_estimate_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vision_target_velocity_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_velocity_estimate_pack(system_id, component_id, &msg , packet1.t_usec , packet1.vx , packet1.vy , packet1.vz , packet1.frame );
	mavlink_msg_vision_target_velocity_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_velocity_estimate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.t_usec , packet1.vx , packet1.vy , packet1.vz , packet1.frame );
	mavlink_msg_vision_target_velocity_estimate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vision_target_velocity_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_target_velocity_estimate_send(MAVLINK_COMM_1 , packet1.t_usec , packet1.vx , packet1.vy , packet1.vz , packet1.frame );
	mavlink_msg_vision_target_velocity_estimate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_vision_target_position_estimate(system_id, component_id, last_msg);
	mavlink_test_vision_target_velocity_estimate(system_id, component_id, last_msg);
}
